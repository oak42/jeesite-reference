...
public class StatsController extends BaseController {
	...
	public String article(@RequestParam Map<String, Object> paramMap, Model model) {
		//【鸣】@RequestParam部分api doc：
		// If the method parameter is Map<String, String> or MultiValueMap<String, String> and a parameter name is not specified,
		// then the map parameter is populated with all request parameter names and values.

...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 */
	public static String entryptPassword(String plainPassword) {	//【typo】encrypt
		String plain = Encodes.unescapeHtml(plainPassword);			//【扣】有必要吗？
		byte[] salt = Digests.generateSalt(SALT_SIZE);
		byte[] hashPassword = Digests.sha1(plain.getBytes(), salt, HASH_INTERATIONS);
		return Encodes.encodeHex(salt)+Encodes.encodeHex(hashPassword);		//【扣】为何一定要encodeHex？
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 * 获取Key加载信息
	 */
	//【扣】自己定义WebContextListener extends org.springframework.web.context.ContextLoaderListener，就为了在console打印一下productName？

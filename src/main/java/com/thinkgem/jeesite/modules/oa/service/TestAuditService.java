...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> {
	...
	public Page<TestAudit> findPage(Page<TestAudit> page, TestAudit testAudit) {	//【扣】CrudService中已经定义同内容的泛型函数啊，这里重复定义，相当于又多余copy了一次？有必要吗？其他service子类的此方法可都是有自己的不同逻辑的...

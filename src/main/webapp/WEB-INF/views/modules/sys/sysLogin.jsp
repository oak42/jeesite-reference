  ...
  <script type="text/javascript">
      $(document).ready(function () {
          $("#loginForm").validate({
              ...
              errorLabelContainer: "#messageBox",				//【鸣】定制 It is also possible to put them↓ into an error container (option errorLabelContainer).
              errorPlacement: function (error, element) {		//【鸣】option errorPlacement, 定制 error message label的位置，(by default, labels are created after the invalid element...)
                  error.appendTo($("#loginError").parent());
              }
          });
      });
      // 如果在框架或在对话框中，则弹出提示并跳转到首页		【扣：什么情形这是？】
...
<div class="footer">
  Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a
    href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a

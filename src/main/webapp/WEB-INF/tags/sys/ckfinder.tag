...
<%@ include file="/WEB-INF/views/include/taglib.jsp" %><%--【扣】引这个，有必要么？用到其他标签库了？--%>
...
<script type="text/javascript">
    function ${input}FinderOpen() {
        ...
        windowOpen(url, "文件管理", 1000, 700);     /*【鸣】中文window name，略骚( window.open()之第二parameter，参见jeesite.js )*/
